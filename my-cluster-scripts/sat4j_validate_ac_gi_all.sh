...
PATCH=$(sed -n ${SGE_TASK_ID}'{p;q}' my-cluster-scripts/patch_ac_gi.txt)

python3 -m bin.revalidate_patch --scenario scenario/sat4j/AC_GI/validate_${SGE_TASK_ID}.txt --patch $PATCH
